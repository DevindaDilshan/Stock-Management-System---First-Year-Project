...
public class User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 100, 708, 350));
        ...
        jPanel1.add(jPanel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 608, 1240, -1));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if(userName.getText().equals("")||userPass.getText().equals("")||userPhone.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please Enter All Data !");
        }
        else {
            String data[] = {userName.getText(),userPass.getText(),userPhone.getText(),jComboBox1.getSelectedItem().toString()};
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String uName = tblModel.getValueAt(jTable1.getSelectedRow(),0).toString();
        String uPass = tblModel.getValueAt(jTable1.getSelectedRow(),1).toString();
        String uPhone = tblModel.getValueAt(jTable1.getSelectedRow(),2).toString();
        //String uRole = tblModel.getValueAt(jTable1.getSelectedRow(),3).toString();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        DefaultTableModel tblModle1 = (DefaultTableModel)jTable1.getModel();
        if(jTable1.getSelectedRowCount() == 1) {
            String name = userName.getText();
            String pass = userPass.getText();
            String phone = userPhone.getText();
            
            tblModle1.setValueAt(name, jTable1.getSelectedRow(),0);
            tblModle1.setValueAt(pass, jTable1.getSelectedRow(),1);
            tblModle1.setValueAt(phone, jTable1.getSelectedRow(),2);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(jTable1.getSelectedRowCount() == 1) {
            tblModle1.removeRow(jTable1.getSelectedRow());
